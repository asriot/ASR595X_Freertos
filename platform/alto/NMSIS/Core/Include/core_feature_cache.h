...
{
    __RV_CSR_WRITE(CSR_CCM_MCMD, ICACHE_INVAL);
    __RV_CSR_WRITE(CSR_MCACHE_FLUSH, 0x1);
 ...
 * \brief  Flush I-Cache
 * \details
 * This function Flush I-Cache
 * \remarks
 * - This \ref CSR_MCACHE_FLUSH register control I-Cache flush.
 * \sa
 * - \ref EnableICache
 */
__STATIC_FORCEINLINE void FlushICache (void)
{
    __RV_CSR_WRITE(CSR_CCM_MCMD, ICACHE_INVAL_ALL);
    __RV_CSR_WRITE(CSR_MCACHE_FLUSH, 0x1);
}
 ...
 * \details
 * This function check if I-Cache is enabled
 * \remarks
 * - This \ref CSR_MCACHE_CTL register control I Cache enable.
 * \sa
 * - \ref EnableICache
 */
__STATIC_FORCEINLINE int IsEnabledICache (void)
{
    return (__RV_CSR_READ(CSR_MCACHE_CTL) & CSR_MCACHE_CTL_IE) ? 1 : 0;
}
...
{
    __RV_CSR_WRITE(CSR_CCM_MCMD, DCACHE_WBINVAL_ALL);
    __RV_CSR_WRITE(CSR_MCACHE_FLUSH, 0x1);
 ...
 * \details
 * This function check if D-Cache is enabled
 * \remarks
 * - This \ref CSR_MCACHE_CTL register control D Cache enable.
 * \sa
 * - \ref EnableDCache
 */
__STATIC_FORCEINLINE int IsEnabledDCache (void)
{
    return (__RV_CSR_READ(CSR_MCACHE_CTL) & CSR_MCACHE_CTL_DE) ? 1 : 0;
}

/**
 * \brief  Flush D-Cache
 * \details
 * This function Flush D-Cache, unlock and invalid all the cacheline
 * \remarks
 * - This \ref CSR_MCACHE_FLUSH register control D-Cache flush.
 * \sa
 * - \ref EnableDCache
 */
__STATIC_FORCEINLINE void FlushDCache (void)
{
    __RV_CSR_WRITE(CSR_CCM_MCMD, DCACHE_INVAL_ALL);
    __RV_CSR_WRITE(CSR_MCACHE_FLUSH, 0x1);
}
 ...
 * \brief  Flush D-Cache
 * \details
 * This function Flush D-Cache, unlock and flush and invalid all the valid and dirty cachelines
 * \remarks
 * - This \ref CSR_MCACHE_FLUSH register control D-Cache flush.
 * \sa
 * - \ref EnableDCache
 */
__STATIC_FORCEINLINE void FlushWbDCache (void)
{
    __RV_CSR_WRITE(CSR_CCM_MCMD, DCACHE_WBINVAL_ALL);
    __RV_CSR_WRITE(CSR_MCACHE_FLUSH, 0x1);
}
