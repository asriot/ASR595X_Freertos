...
extern void (*pf_assert_err)(uint16_t id, int cond);
extern void (*pf_assert_param)(uint16_t id, int param0, int param1);
extern void (*pf_assert_warn)(uint16_t id, int param0, int param1);
...
#define ASSERT_INFO(id, cond, param0, param1)                             \
    do {                                                              \
        if (!(cond)) {                                                \
            if(pf_assert_param)                                       \
            {                                                         \
                pf_assert_param(id, (int)param0, (int)param1);            \
            }                                                         \
        }                                                             \
    } while(0)
...
#define ASSERT_WARN(id, cond, param0, param1)                                      \
   do {                                                                        \
       if (!(cond)) {                                                          \
           if(pf_assert_warn)                                                  \
           {                                                                   \
               pf_assert_warn(id, (int)param0, (int)param1);                       \
           }                                                                   \
       }                                                                       \
   } while(0)
...
#include "asr_common.h"     // ll definitions
