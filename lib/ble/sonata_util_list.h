...
#include "sonata_utils_api.h"       // for __SONATA_INLINE
 ...
 ****************************************************************************************
 */
__SONATA_INLINE bool util_list_is_empty(const struct util_list *const list)
{
    bool listempty;
 ...
 ****************************************************************************************
 */
__SONATA_INLINE struct util_list_hdr *util_list_pick(const struct util_list *const list)
{
    return(list->first);
}
 ...
 ****************************************************************************************
 */
__SONATA_INLINE struct util_list_hdr *util_list_next(const struct util_list_hdr *const list_hdr)
{
