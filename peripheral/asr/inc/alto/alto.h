...
#define UART_BUS_CLK_BIT_OFFSET  1
#define UART_PERI_CLK_BIT_OFFSET 14

#define PERI_CLK_EN_REG0        (0X40000840)
#define PERI_CLK_DIS_REG0       (0X40000848)
#define PSRAM_CLK_BIT           ((1 << 4) | (1 << 5))
#define DMA_CLK_EN              (1<<13)

#define PERI_CLK_EN_REG1        (0X40000844)
#define PERI_CLK_DIS_REG1       (0X4000084C)
#define I2S_CLK_BIT             ((1 << 13) | (1 << 24))
#define WDG_BUS_CLK_BIT         (0X01<<9)
#define TIMER_BUS_CLK_BIT       (0X01<<10)
#define PWM_BUS_CLK_BIT         (0X01<<11)


#define SPI_BUS_CLK_BIT_OFFSET  4
#define SPI_PERI_CLK_BIT_OFFSET 17
#define I2C_BUS_CLK_BIT_OFFSET  7
#define I2C_PERI_CLK_BIT_OFFSET 20
#define GPIO_CONTROLLER_CLK_BIT_OFFSET 7
#define GPIO_PERI_CLK_BIT_OFFSET  8


#define GPIO_IRQ_BIT_OFFSET     4
#define UART_IRQ_BIT_OFFSET     8
#define SPI_IRQ_BIT_OFFSET      11
#define I2C_IRQ_BIT_OFFSET      14



#define IRQ_EN_REG              (SYS_CON_REG_BASE + 0x944)
#define IRQ_DIS_REG             (SYS_CON_REG_BASE + 0x948)
#define DMA_IRQ_BIT             (1<<7)
#define I2S_IRQ_BIT             (1<<24)
#define WDG_IRQ_BIT             (0X01<<2)
#define TIMER_IRQ_BIT           (0X01<<5)
#define PWM_IRQ_BIT             (0X01<<21)
...
//clock
extern uint32_t system_bus_clk; //defined in system_canon.c
extern uint32_t system_core_clk;
extern uint32_t system_peri_clk;

#define RTC_ALARM_WAKEUP_BIT_OFFSET 0
#define SLEEP_IRQ_BIT_OFFSET 1
#define ALTO_IRQ_STS_REG_ADDR           0x40000AA0
#define RTC_IRQ_STS_REG ALTO_IRQ_STS_REG_ADDR
...
#define RETENTION_SRAM                    ((struct ALTO_RETENTION_SRAM *)(RETENTION_RAM_ADDR))
...
#define WATCHDOG ((struct ALTO_WDOG *)(WDOG_BASE))
...
#define TIMER1 ((struct ALTO_TIMER *)(TIMER1_REG_BASE))
#define TIMER2 ((struct ALTO_TIMER *)(TIMER2_REG_BASE))
...
#define PWM ((struct ALTO_PWM *)(PWM_REG_BASE))
...
#define EFUSE ((struct ALTO_EFUSE *)(EFUSE_CTRL_BASE))
